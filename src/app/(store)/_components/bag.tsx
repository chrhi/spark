    ...
    <Sheet>
      ...
      <SheetContent className="p-0 ">
        {products.length === 0 ? (
          ...
          // // <div className="w-full my-auto h-full flex flex-col gap-y-2 justify-between items-center ">
          // //   <div className="w-full h-fit min-h-[20rem] flex flex-col gap-y-4  ">
          // //     {products.map((item) => {
          // //       return (
          // //         <div
          // //           key={item.id}
          // //           className="w-full h-[50px] p-4 flex items-center justify-start gap-x-4"
          // //         >
          // //           <Image
          ...
          // //     })}
          // //   </div>
          // //   <div className="flex px-6 items-center justify-center w-full h-[100px]">
          // //     <Button className="w-full rounded-full h-[50px] font-bold text-xl">
          // //       Order Now
          // //     </Button>
          // //   </div>
          // </div>
